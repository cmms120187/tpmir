...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // This assumes we can find MachineErp by matching idMachine from Machine
        DB::statement('
            UPDATE predictive_maintenance_schedules pms
        ...
        DB::statement('UPDATE predictive_maintenance_schedules SET machine_erp_id = machine_id');

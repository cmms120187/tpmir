...
class RoleMiddleware
{
    ...
    private function getMenuKeyFromRoute($routeName)
    {
        $routeMenuMap = [
            ...
            'preventive-maintenance.reporting.schedule' => 'preventive-reporting',
            'preventive-maintenance.reporting.execution' => 'preventive-reporting',
            ...
            'predictive-maintenance.updating.update' => 'predictive-updating',
            'predictive-maintenance.updating.get-maintenance-points-by-machine-and-date' => 'predictive-updating',
            'predictive-maintenance.reporting.index' => 'predictive-reporting',
            'predictive-maintenance.reporting.schedule' => 'predictive-reporting',
            'predictive-maintenance.reporting.execution' => 'predictive-reporting',
            'predictive-maintenance.reporting.performance' => 'predictive-reporting',
            'predictive-maintenance.reporting.get-schedule-points-by-machine-and-date' => 'predictive-reporting',
            'predictive-maintenance.reporting.get-point-trends-by-machine' => 'predictive-reporting',

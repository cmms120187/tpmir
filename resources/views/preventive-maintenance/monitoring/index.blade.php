...
<div class="w-full p-4 sm:p-6 lg:p-8">
    <div class="w-full mx-auto">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Preventive Maintenance - Monitoring</h1>
                <p class="text-sm text-gray-500 mt-1">Tanggal Hari Ini: {{ \Carbon\Carbon::now()->locale('id')->translatedFormat('l, d F Y') }}</p>
            </div>
            <div class="flex items-center gap-3">
                <!-- Filter Section -->
                <form method="GET" action="{{ route('preventive-maintenance.monitoring.index') }}" class="flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-500">Pending Executions</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $stats['pending_executions'] ?? 0 }}</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
            <div class="bg-white rounded-lg shadow p-6 lg:col-span-2">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Monthly Completion Trend</h3>
                <div class="h-64">
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: [
                        ...
                        'rgb(234, 179, 8)',   // Yellow for In Progress
                        'rgb(156, 163, 175)', // Grey for Pending

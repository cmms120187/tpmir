    ...
    <div class="w-full mx-auto">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Preventive Maintenance Executions</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
            <form method="GET" action="{{ route('preventive-maintenance.reporting.execution') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                ...
                <div class="md:col-span-4 flex justify-end gap-2">
                    ...
                    <a href="{{ route('preventive-maintenance.reporting.execution') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-6 rounded shadow transition">
                        Reset
                    </a>
                </div>
            </form>
        ...
        <!-- Statistics Cards -->
        <!-- {{-- Grid 4 kolom: Total, Completed, Pending, In Progress --}} -->
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <p class="text-2xl font-bold text-purple-600">
                    {{ $stats['avg_duration'] ? number_format($stats['avg_duration'], 1) . ' min' : '-' }}
                </p>
            </div>
        </div>

        <!-- {{-- Grid 2 kolom: Total Cost, Avg Duration --}} -->
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-500">
                                    {{ $execution->actual_end_time ? \Carbon\Carbon::parse($execution->actual_end_time)->format('d/m/Y H:i') : '-' }}
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-500">

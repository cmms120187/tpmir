...
<div class="w-full p-4 sm:p-6 lg:p-8">
    <div class="w-full max-w-6xl mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Create Downtime ERP</h1>
        @if($errors->any())
        ...
        @endif
        <form action="{{ route('downtime_erp.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
            @csrf
            <!-- Informasi Mesin -->
            <div class="mb-6 p-4 border rounded-lg bg-gray-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="typeMachine" value="{{ old('typeMachine') }}" class="w-full border rounded px-3 py-2 @error('typeMachine') border-red-500 @enderror">
                        @error('typeMachine')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="modelMachine" value="{{ old('modelMachine') }}" class="w-full border rounded px-3 py-2 @error('modelMachine') border-red-500 @enderror">
                        @error('modelMachine')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="brandMachine" value="{{ old('brandMachine') }}" class="w-full border rounded px-3 py-2 @error('brandMachine') border-red-500 @enderror">
                        @error('brandMachine')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="roomName" value="{{ old('roomName') }}" class="w-full border rounded px-3 py-2 @error('roomName') border-red-500 @enderror">
                        @error('roomName')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="plant" value="{{ old('plant') }}" class="w-full border rounded px-3 py-2 @error('plant') border-red-500 @enderror">
                        @error('plant')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="process" value="{{ old('process') }}" class="w-full border rounded px-3 py-2 @error('process') border-red-500 @enderror">
                        @error('process')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="line" value="{{ old('line') }}" class="w-full border rounded px-3 py-2 @error('line') border-red-500 @enderror">
                        @error('line')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-6 p-4 border rounded-lg bg-gray-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="date" value="{{ old('date') }}" required class="w-full border rounded px-3 py-2 @error('date') border-red-500 @enderror">
                        @error('date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="stopProduction" value="{{ old('stopProduction') }}" class="w-full border rounded px-3 py-2 @error('stopProduction') border-red-500 @enderror" placeholder="HH:mm">
                    ...
                    <div>
                        ...
                        <input type="text" name="responMechanic" value="{{ old('responMechanic') }}" class="w-full border rounded px-3 py-2 @error('responMechanic') border-red-500 @enderror" placeholder="HH:mm">
                    ...
                    <div>
                        ...
                        <input type="text" name="startProduction" value="{{ old('startProduction') }}" class="w-full border rounded px-3 py-2 @error('startProduction') border-red-500 @enderror" placeholder="HH:mm">
                    ...
                    <div>
                        ...
                        <input type="text" name="duration" value="{{ old('duration') }}" class="w-full border rounded px-3 py-2 @error('duration') border-red-500 @enderror">
                        @error('duration')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="Standar_Time" value="{{ old('Standar_Time') }}" class="w-full border rounded px-3 py-2 @error('Standar_Time') border-red-500 @enderror">
                        @error('Standar_Time')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="problemDowntime" value="{{ old('problemDowntime') }}" class="w-full border rounded px-3 py-2 @error('problemDowntime') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="Problem_MM" value="{{ old('Problem_MM') }}" class="w-full border rounded px-3 py-2 @error('Problem_MM') border-red-500 @enderror">
                        @error('Problem_MM')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="reasonDowntime" value="{{ old('reasonDowntime') }}" class="w-full border rounded px-3 py-2 @error('reasonDowntime') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="actionDowtime" value="{{ old('actionDowtime') }}" class="w-full border rounded px-3 py-2 @error('actionDowtime') border-red-500 @enderror">
                        @error('actionDowtime')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="groupProblem" value="{{ old('groupProblem') }}" class="w-full border rounded px-3 py-2 @error('groupProblem') border-red-500 @enderror">
                        @error('groupProblem')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-6 p-4 border rounded-lg bg-gray-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="idMekanik" value="{{ old('idMekanik') }}" class="w-full border rounded px-3 py-2 @error('idMekanik') border-red-500 @enderror">
                        @error('idMekanik')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="nameMekanik" value="{{ old('nameMekanik') }}" class="w-full border rounded px-3 py-2 @error('nameMekanik') border-red-500 @enderror">
                        @error('nameMekanik')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="idLeader" value="{{ old('idLeader') }}" class="w-full border rounded px-3 py-2 @error('idLeader') border-red-500 @enderror">
                        @error('idLeader')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="nameLeader" value="{{ old('nameLeader') }}" class="w-full border rounded px-3 py-2 @error('nameLeader') border-red-500 @enderror">
                        @error('nameLeader')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="idCoord" value="{{ old('idCoord') }}" class="w-full border rounded px-3 py-2 @error('idCoord') border-red-500 @enderror">
                        @error('idCoord')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="nameCoord" value="{{ old('nameCoord') }}" class="w-full border rounded px-3 py-2 @error('nameCoord') border-red-500 @enderror">
                        @error('nameCoord')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="Part" value="{{ old('Part') }}" class="w-full border rounded px-3 py-2 @error('Part') border-red-500 @enderror">
                        @error('Part')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded shadow transition">Simpan</button>

...
<div class="w-full p-4 sm:p-6 lg:p-8">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow p-6 sm:p-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Create Part ERP</h1>
            <p class="text-sm text-gray-600">Add new part ERP entry (all fields are manual input)</p>
        </div>
        ...
        <form action="{{ route('part-erp.store') }}" method="POST">
            @csrf

                                ...
                                @if($displayPhoto)
                                    @php
                                        ...
                                        if (strpos($displayPhoto, 'images/') === 0) {
                                            ...
                                            $photoUrl = asset($displayPhoto);
                                        } elseif (strpos($displayPhoto, 'standards/') === 0) {
                                            // New format: standards/xxx.jpg -> use Storage::url
                                            $photoUrl = Storage::url($displayPhoto);
                                        } else {
                                    ...
                                    @endphp
                                    @if($photoUrl)
                                        <img src="{{ $photoUrl }}" alt="{{ $standard->name }}" class="w-16 h-16 object-cover rounded border" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                    @endif
                                @else

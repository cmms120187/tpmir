...
<div class="max-w-xl mx-auto p-8 bg-white rounded shadow">
    <h1 class="text-2xl font-bold mb-6">Create Problem MM</h1>
    <form action="{{ route('problem_mms.store') }}" method="POST">
        @csrf
        <div class="mb-4">
        ...
        <a href="{{ route('problem_mms.index') }}" class="ml-4 text-gray-600 hover:underline">Cancel</a>
    </form>
</div>
@endsection

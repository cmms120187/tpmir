                    ...
                    <div class="mb-4">
                        ...
                        <select name="type_id" 
                            ...
                            @foreach($machineTypes as $machineType)
                                <option value="{{ $machineType->id }}" {{ old('type_id', $model->type_id) == $machineType->id ? 'selected' : '' }}>{{ $machineType->name }}</option>
                            @endforeach
                        </select>
                        @error('type_id')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div class="mb-4">
                    ...
                    @if($model->photo)
                        <div class="mb-2">
                            ...
                            <img src="{{ asset('storage/' . $model->photo) }}" alt="Current Photo" class="max-w-xs max-h-48 object-cover rounded border">
                        </div>
                    @endif
                    <input type="file" 
                           name="photo" 
